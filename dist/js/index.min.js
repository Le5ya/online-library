...
var getStars = function getStars(rating) {
  ...
  for (var i = 0; i < 5; i++) {
    if (i === 0) {
      stars.push("<img class=\"star cart__rating-star\" src=\"./img/star.svg\" alt=\"\u0420\u0435\u0442\u0438\u043D\u0433 ".concat(rating, " \u0438\u0437 5\">"));
    } else if (i < rating) {
      stars.push("<img class=\"star cart__rating-star\" src=\"./img/star.svg\" alt=\"\">");
    } else {
      stars.push("<img class=\"star cart__rating-star\" src=\"./img/star-o.svg\" alt=\"\">");
    }
  }
...
var renderBook_libraryList = document.querySelector('.library__list');
...
var _add = document.querySelector('.add'); // const backBtns = document.querySelectorAll('.header__btn-back');
...
var btnSearch = document.querySelectorAll('.header__btn-search');
...
document.body.addEventListener('click', closeSearch); // closeSearch()
...
document.body.addEventListener('click', closeSearch, true);
/* harmony default export */ var modules_search = ((/* unused pure expression or super */ null && (closeSearch)));
