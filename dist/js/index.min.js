...
var backBtns = document.querySelectorAll('.header__btn-back');
...
controlField(fieldsBtnFilter, fieldsListFilter, fieldsListSort); //if (window.NodeList && !NodeList.prototype.forEach) {
